    ...
    <section className="py-16 bg-blue-600">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
          Join thousands of verified commuters saving money and traveling safely every day.
        </p>
        ...
        <button className="bg-white hover:bg-gray-100 text-blue-600 px-8 py-3 rounded-lg text-lg font-bold shadow-lg">
          Get Started Today
        </button>
          ...
          <div className="flex items-start justify-center text-left">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">
                GPS tracking, emergency contacts, and 24/7 support for complete peace of mind.
              </p>
            </div>
          </div>
        </div>
