    ...
    <section className="pt-20 pb-16 bg-blue-50">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Connect with verified commuters. Save money, reduce pollution, and travel safely with GPS tracking.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 shadow-md">
            <Search className="w-5 h-5" />
            Find a Ride
          </button>
          <button className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 shadow-md">
        ...
        <div className="bg-white rounded-lg p-4 max-w-2xl mx-auto shadow-sm border">
          <p className="text-gray-700 flex items-start">
            ...
            Security Promise: GPS tracking, emergency contacts, and 24/7 support for your safety.
          </p>
        </div>
      </div>
    </section>
